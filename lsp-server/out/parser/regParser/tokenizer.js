...
const OTHER_MARK = new Map([
    ["{", types_1.TokenType.openBrace], ["}", types_1.TokenType.closeBrace],
    ["[", types_1.TokenType.openBracket], ["]", types_1.TokenType.closeBracket],
    ["(", types_1.TokenType.openParen], [")", types_1.TokenType.closeParen],
    ["/*", types_1.TokenType.openMultiComment], ["*/", types_1.TokenType.closeMultiComment],
    [";", types_1.TokenType.lineComment], ["=", types_1.TokenType.equal],
    ["#", types_1.TokenType.sharp], [",", types_1.TokenType.comma], [".", types_1.TokenType.dot], ["!", types_1.TokenType.not],
    ["&", types_1.TokenType.and], ["|", types_1.TokenType.or], ["^", types_1.TokenType.xor],
    ["&&", types_1.TokenType.logicand], ["||", types_1.TokenType.logicor],
    ["+", types_1.TokenType.plus], ["-", types_1.TokenType.minus], ["*", types_1.TokenType.multi],
    ["/", types_1.TokenType.div], ["//", types_1.TokenType.idiv], ["**", types_1.TokenType.power], [">", types_1.TokenType.greater],
    ["<", types_1.TokenType.less], [">=", types_1.TokenType.greaterEqual], ["<=", types_1.TokenType.lessEqual],
    ["?", types_1.TokenType.question], [":", types_1.TokenType.colon], ["::", types_1.TokenType.hotkey],
    // equals
    [":=", types_1.TokenType.aassign], ["= ", types_1.TokenType.equal], ["+=", types_1.TokenType.pluseq],
    ["-=", types_1.TokenType.minuseq], ["*=", types_1.TokenType.multieq], ["/=", types_1.TokenType.diveq],
    ["//=", types_1.TokenType.idiveq], [".=", types_1.TokenType.sconneq], ["|=", types_1.TokenType.oreq],
    ["&=", types_1.TokenType.andeq], ["^=", types_1.TokenType.xoreq], [">>=", types_1.TokenType.rshifteq],
    ["<<=", types_1.TokenType.lshifteq], ["~=", types_1.TokenType.regeq]
]);
